...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Recipes: Attribute.DynamicZone<['recipe-category.recipe']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRecipeRecipe extends Schema.CollectionType {
  ...
  attributes: {
    ...
    IngredientList: Attribute.Component<
      'recipe-content.ingredient-component',
      true
    >;
    ServingSize: Attribute.Decimal & Attribute.DefaultTo<1>;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    recipes: Attribute.Relation<
      ...
      'api::recipe.recipe'
    >;
    tag_name_short: Attribute.String;
    color: Attribute.Enumeration<
      ['red', 'blue', 'green', 'purple', 'pink', 'orange', 'yellow', 'grey']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
